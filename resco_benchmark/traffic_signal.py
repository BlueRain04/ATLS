...
class Signal:
    ...
    def observe(self, step_length, distance):#initilize full_observation dict, we will use in state rep, 
        full_observation = dict()
        all_vehicles = set()
        for lane in self.lanes:
            vehicles = []
            lane_measures = {'queue': 0, 'approach': 0, 'total_wait': 0, 'max_wait': 0}#important info!
